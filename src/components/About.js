...
export default function About(){
    return (
        <div data-aos="fade-up" id="about" className="about bg-black-100 container px-8 md:mb-12 bg-black overflow-hidden max-w-6xl mx-auto min-h-full mt-8 sm:mt-8 sm:px-1 md:px-4 md:mt-18 lg:mt-18 xl:mt-20">
