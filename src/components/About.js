...
export default function About(){
    return (
        <div data-aos="fade-up" className="bg-black-100 container px-8 bg-black overflow-hidden max-w-6xl mx-auto min-h-full mt-8 sm:mt-8 sm:px-1 md:px-4 md:mt-2 lg:mt-18 xl:mt-20">
