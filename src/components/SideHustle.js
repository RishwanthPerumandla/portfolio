...
export default function SideHustle(){
    ...
    return(
               <main className="sidehustles bg-black-100 container  md:mb-10 lg:mb-18 xl:mb-20 px-8 bg-black overflow-hidden max-w-6xl mx-auto min-h-full mt-8 sm:mt-8 sm:px-4  md:px-4  md:mt-2 lg:mt-18 xl:mt-20">
